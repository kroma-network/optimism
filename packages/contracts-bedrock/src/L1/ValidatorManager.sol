...
contract ValidatorManager is ISemver {
    ...
    function initialize(ConstructorParams memory _constructorParams) public initializer {
        if (_constructorParams._minRegisterAmount > _constructorParams._minActivateAmount) {
            revert InvalidConstructorParams();
        }

        l2Oracle = _constructorParams._l2Oracle;
        assetManager = _constructorParams._assetManager;
        trustedValidator = _constructorParams._trustedValidator;
        minRegisterAmount = _constructorParams._minRegisterAmount;
        minActiveAmount = _constructorParams._minActivateAmount;
        commissionChangeDelaySeconds = _constructorParams._commissionChangeDelaySeconds;
        // Note that this value MUST be (SUBMISSION_INTERVAL * L2_BLOCK_TIME) / 2.
        roundDurationSeconds = _constructorParams._roundDurationSeconds;
        softJailPeriodSeconds = _constructorParams._softJailPeriodSeconds;
        hardJailPeriodSeconds = _constructorParams._hardJailPeriodSeconds;
        jailThreshold = _constructorParams._jailThreshold;
        maxOutputFinalizations = _constructorParams._maxOutputFinalizations;
        baseReward = _constructorParams._baseReward;
    }
