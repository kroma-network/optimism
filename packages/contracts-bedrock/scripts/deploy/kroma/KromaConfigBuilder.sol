...
library KromaConfigBuilder {
    ...
    function fromConfig(DeployConfig cfg) internal view returns (KromaDeployInput memory) {
        return KromaDeployInput({
            ...
            guardianPeriodSeconds: cfg.colosseumGuardianPeriodSeconds(),
            maxClockDurationSeconds: cfg.colosseumMaxClockDurationSeconds(),
            challengeGracePeriodSeconds: cfg.colosseumChallengeGracePeriodSeconds(),
