...
contract L2OutputOracle_getter_Test is L2OutputOracle_TestBase {
    ...
    function test_getL2OutputIndexAfter_multipleOutputsExist_succeeds() external {
        ...
        assertEq(
            keccak256(abi.encode(l2OutputOracle.getL2Output(index1))),
            keccak256(abi.encode(trusted, output2, l2OutputOracle.computeL2Timestamp(nextBlockNumber2) + 2, nextBlockNumber2))
        );
        ...
        assertEq(
            ...
            keccak256(abi.encode(trusted, output3, l2OutputOracle.computeL2Timestamp(nextBlockNumber3) + 2, nextBlockNumber3))
        );
        ...
        assertEq(
            ...
            keccak256(abi.encode(trusted, output4, l2OutputOracle.computeL2Timestamp(nextBlockNumber4) + 2, nextBlockNumber4))
        );
    }
...
contract L2OutputOracle_proposeL2Output_Test is L2OutputOracle_TestBase {
    ...
    function test_proposeL2Output_wrongFork_reverts() external {
        ...
        l2OutputOracle.submitL2Output(nonZeroHash, nextBlockNumber, bytes32(uint256(0x01)), block.number);
    }
