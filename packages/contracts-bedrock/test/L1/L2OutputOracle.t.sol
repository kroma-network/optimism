...
contract L2OutputOracle_TestBase is CommonTest {
    ...
    //     /// @dev Tests that `getL2OutputAfter` of an L2 block number returns the L2 output of the
    // `getL2OutputIndexAfter` of
    //     /// that block number.
    ...
    //         assertEq(
    //             keccak256(abi.encode(l2OutputOracle.getL2Output(index1))),
    //             keccak256(abi.encode(output2, l2OutputOracle.computeL2Timestamp(nextBlockNumber2) + 1,
    // nextBlockNumber2))
    //         );
    ...
    //             keccak256(abi.encode(output3, l2OutputOracle.computeL2Timestamp(nextBlockNumber3) + 1,
    // nextBlockNumber3))
    //         );
    ...
    //             keccak256(abi.encode(output4, l2OutputOracle.computeL2Timestamp(nextBlockNumber4) + 1,
    // nextBlockNumber4))
    //         );
    //     }
    ...
    //         assertEq(
    //             l2OutputOracle.computeL2Timestamp(startingBlockNumber + 96024), startingTimestamp + l2BlockTime *
    // 96024
    //         );
    //     }
    // }
